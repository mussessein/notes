...
/*
AVLTree在二分搜索树的基础上增加高度值height
1.定义高度属性(左右子树中最大高度+1)
2.定义平衡因子(左右子树高度差,这里定义为 左-右)
3.在add方法,添加节点时,维护height值
4.处理四种不平衡状态
  在add方法中进行维护平衡(平衡因子!=0 则不平衡)
5.删除节点
 */
public class AVLTree<K extends Comparable<K>, V> {
    ...
    情况三:LR
       node               node                   z
       /  \               / \                  /  \
      x   T4   对X左旋转   z  T4  对node右旋转   x   node
     / \       ----->   / \      ------->    / \   / \
